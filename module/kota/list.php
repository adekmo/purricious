<div id="frame-tambah">
	<a class="tombol-action" href="<?php echo BASE_URL."index.php?page=myprofile&module=kota&action=form"; ?>">+ Tambah Kota</a>
</div>
		...
		echo "<table class='table-list'>";
			...
			while($rowKota=mysqli_fetch_assoc($queryKota)){
				echo "<tr>
						...
						<td class='tengah'>
							<a class='tombol-action' href='".BASE_URL."index.php?page=myprofile&module=kota&action=form&kota_id=$rowKota[kota_id]"."'>Edit</a>
						</td>
					 </tr>";
